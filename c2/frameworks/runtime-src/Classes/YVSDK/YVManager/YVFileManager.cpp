...
YVFilePathPtr YVFileManager::getYVPathByUrl(const std::string& url)
{
...
YVFilePathPtr YVFileManager::getYVPathByLocal(const std::string& path)
{
	for (FileMap::iterator it = m_files.begin();
		it != m_files.end(); ++it)
	{
...
YVFilePathPtr YVFileManager::getYVPathByRand(const std::string& extren)
{
