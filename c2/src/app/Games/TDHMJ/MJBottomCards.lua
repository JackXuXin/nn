    ...
    if combin == "peng" then
     ...
     elseif combin == "chi" then
        local temp =  display.newSprite("#ShYMJ/img_spe_card.png")
            ...
            :pos(60,0)
            :addTo(sprite)
            display.newSprite(string.format("#ShYMJ/img_cardvalue_cpg%d.png", card[3]))
            :pos(30, 54)
            :addTo(temp)
...
--吃的传参需要修改
function MJBottomCards:combinCard(combin, card, direct,chi)
