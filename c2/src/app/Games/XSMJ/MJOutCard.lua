...
function MJOutCard:ctor()
    ...
    frame = cc.SpriteFrame:createWithTexture(texture, cc.rect(0, 0, 132, 176))
    ...
    for i = 1, 5 do
        for j = 1, 9 do
            local frame = cc.SpriteFrame:createWithTexture(texture, cc.rect(79*(j-1), 100*(i-1), 79, 100))
    ...
    frame = cc.SpriteFrame:createWithTexture(texture, cc.rect(0, 0, 65, 78))
    ...
    frame = cc.SpriteFrame:createWithTexture(texture, cc.rect(0, 0, 66, 80))
    ...
    frame = cc.SpriteFrame:createWithTexture(texture, cc.rect(0, 0, 65, 80))
    ...
    frame = cc.SpriteFrame:createWithTexture(texture, cc.rect(0, 0, 115, 60))
...
function MJOutCard:outCard(card, direct)
    ...
    if direct == "left" then
        showCard:pos(display.left + 185, display.cy + 34)
    elseif direct == "right" then
        showCard:pos(display.right - 185, display.cy + 34)
