...
function MJPlayers:setHeadImage(imageid, img_head, image)

    local img_userinfobg = self
    ...
    if imageid ~= nil and imageid ~= "" then
        ...
        print("newUrl:",url)
        local icontest = NetSprite.new(url,image):addTo(img_userinfobg)
        --icontest:setPosition(100,34)
...
--modify end
         ...
         --设置微信头像
        util.setHeadImage(leftHead:getParent(), imageid, leftHead, image, 1)
...
--modify end
     util.setHeadImage(rightHead:getParent(), imageid, rightHead, image, 2)
    ...
    --modify end
        ...
        util.setHeadImage(topHead:getParent(), imageid, topHead, image, 3)
       -- topName:setColor(cc.c3b(255, 0, 0))
...
print("eeeeeee---------")
    ...
    --modify end
        ...
        util.setHeadImage(bottomHead:getParent(), imageid, bottomHead, image, 4)
    end
...
function MJPlayers:setCombin(combin, card, index)--index 代表可以杠的数目  out 0或1
