...
function MJResult:hunPoints(points,index)
    ...
    local str = ""
    for i = 1, count do
        if points[i].hun == "dui_dui_peng" then
            str = "对对碰1龙 "
        elseif points[i].hun == "qing_7_dui" then
            str = str .." 清七对10龙 "
        elseif points[i].hun == "da_dui_dui" then
            str = str .." 大对对1龙 "
        elseif points[i].hun == "quan_feng_xiang" then
            str = str .." 全风向50龙 "
        elseif points[i].hun == "13_bu_da" then
            str = str .." 十三不搭1龙 "
        elseif points[i].hun == "7_feng_qi" then
            str = str .." 七风齐1龙 "
        elseif points[i].hun == "1_gang_1_da" then
            str = str .." 一杠一达1龙 "
        elseif points[i].hun == "2_gang_2_da" then
            str = str .." 二杠二达1龙 "
        elseif points[i].hun == "3_gang_3_da" then
            str = str .." 三杠三达1龙 "
        ...
        elseif points[i].hun == "di_hu" then
            str = str .." 地胡10龙 "
        elseif points[i].hun == "gang_bao" then
            str = str .." 杠爆10龙 "
        elseif points[i].hun == "hai_di_lao_yue" then
            str = str .." 海底捞月10龙 "
        elseif points[i].hun == "dan_diao" then
            str = str .." 单吊10龙 "
        elseif points[i].hun == "pao_long" then
            str = str .." 拋龙10龙 "
        elseif points[i].hun == "zi_mo" then
            str = str .." 自摸 "
        elseif points[i].hun == "da_hu" then
            str = str .." 打胡 "
        elseif points[i].hun == "qiang_gang_hu" then
            str = str .." 抢杠胡 "
        elseif points[i].hun == "wu_long" then
            str = str .." 无龙2龙 "
        elseif points[i].hun == "si_long_qi" then
            str = str .." 4龙齐50龙 "
        elseif points[i].hun == "11_lian_feng" then
            str = str .." 11连风50龙 "
        elseif points[i].hun == "gang_san_ci" then
            str = str .." 杠三次50龙 "
        elseif points[i].hun == "cai_shen" then
            str = str .." 财神" ..tostring(points[i].point) .."龙 "
...
--创建结算面板
function MJResult:createResult(result, watching,heads,weixinImage)
    --牌的相对位置
    ...
    for i=1,#result.scores do
        if result.scores[i].banker_cnt>0 then
            lianzhuang=result.scores[i].banker_cnt
        end
        if result.scores[i].banker_long_cnt>0 then
            dilong=result.scores[i].banker_long_cnt
        end
    end
    cc.ui.UILabel.new({
    ...
    for i = 1,#result.scores do
        ...
        local scoreL = cc.ui.UILabel.new({
            text = tostring(result.scores[i].total_dragon_cnt), 
            size = 22, 
            color = cc.c3b(255,255,255)
            })
        :addTo(bg_result)
...
function MJResult:setResult(result, watching,heads,table_code,weixinImage)
    ...
    self:createResult(result, watching, heads,weixinImage)
